...
/* This is your interface file. Note: I have not fully tested this yet,
as time has been short. Hopefully there are no major errors in it,
and you should not need to make any major changes to this file.

Also note, there is currently little to no data validation happening in this
code, so when you run it, choose your inputs carefully.
Do not just test it on meaningless input, as it will affect your database.

YOU DO NEED TO EDIT THE PROMPT FOR THE CUSTOMERS PHONE NUMBER,
TO LET ME KNOW WHAT FORMAT IT SHOULD BE (with dashes, or without, etc.)
 */
